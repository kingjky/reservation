		...
		<div class="header">
			<header class="header_tit">
				<h1 class="logo">
					...
					</a> <a href="./html/myreservation.html" class="lnk_logo" title="예약"> <span
							class="spr_bi ico_bk_logo">예약</span>
					</a>
				</h1>
				<a href="./html/bookinglogin.html" class="btn_my"> <span class="viewReservation" title="예약확인">예약확인</span>
				</a>
			</header>
		</div>
		<hr>
