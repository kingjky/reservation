...
<body class="biz  ko">
				...
				<div class="booking_login">
					...
					<form name="confirm_form" class="ng-pristine ng-valid" id="form1">
						...
						<div class="login_form">
							<label class="label_form" for="resrv_id" translate="CM-BOOKING_NUMBER">
								예약자 이메일 입력
							</label>
							<input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty"
								id="resrv_id" name="resrv_email" aria-invalid="false" placeholder="crong@naver.com"
								title="예매자이메일">
						</div>
						<button type="button" class="login_btn confirm">
				...
				<ul class="lst_link">
					...
					<li class="item">
						<a href="https://m.booking.naver.com/#" class="anchor">
							<span translate="CM-CUSTOMER_CENTER_NBOOKING">네이버 예약 고객센터</span>
						</a>
					</li>
				</ul>
	...
	<script type="module" src="./js/views/bookinglogin.js"></script>
</body>
