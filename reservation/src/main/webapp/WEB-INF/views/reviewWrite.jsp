...
<body>
			...
			<div class="ct_wrap">
				...
				<div class="review_contents write">
					...
					<a class="review_write_info">
						<span class="middot">실 사용자의 리뷰는 상품명의 더 나은 서비스 제공과 다른 사용자들의 선택에 큰 도움이 됩니다. </span>
						<br>
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<div class="guide_review">
							<span class="length">0</span>/400 <span>(최소5자이상)</span>
						</div>
					</div>
						...
						<div class="item_preview_thumbs">
							<ul class="lst_thumb">
								<li class="item" style="display: none;">
									...
									<img src="http://naverbooking.phinf.naver.net/20170306_3/1488772023601A4195_JPEG/image.jpg?type=f300_300"
	...
	<script type="module" src="./js/views/reviewWrite.js"></script>
</body>
